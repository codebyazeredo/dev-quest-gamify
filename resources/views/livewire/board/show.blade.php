<div class="flex flex-1 min-h-0 flex-col">
    <div class="mb-6 flex items-center justify-between">
        ...
        @can('update', $board)
            <button type="button" wire:click="toggleEdit" title="Editar board" aria-label="Editar board" class="rounded-md border p-2 text-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">
