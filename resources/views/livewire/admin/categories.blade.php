<div>
    <h1 class="mb-6 text-xl font-semibold text-gray-800 dark:text-gray-100">Categories</h1>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 text-left text-gray-500 dark:bg-gray-900 dark:text-gray-400">
                <tr>
                    ...
                    <th class="px-4 py-2">Base points</th>
                ...
                @foreach ($categories as $category)
                    <tr wire:key="category-{{ $category->id }}">
                        ...
                        @else
                            ...
                            <td class="px-4 py-2 text-right">
                                <button type="button" wire:click="edit({{ $category->id }})" class="text-indigo-600 hover:underline">Edit</button>
                                <button type="button" wire:click="delete({{ $category->id }})" wire:confirm="Delete this category?" class="ml-2 text-red-600 hover:underline">Delete</button>
                            </td>
                        @endif
                    </tr>
                @endforeach
    ...
    <form wire:submit="create" class="mt-6 flex items-end gap-2">
        <div class="flex-1">
            <label for="new-category-name" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Name</label>
        ...
        <div>
            <label for="new-category-points" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Base points</label>
