<x-modal title="Editar regra de XP">
    <form wire:submit="save" class="space-y-4">
        ...
        <div>
            ...
            <input type="number" min="0" wire:model="xp_reward" autofocus class="mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100">
