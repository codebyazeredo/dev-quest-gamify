                ...
                @foreach ($challenges as $challenge)
                    <tr wire:key="challenge-{{ $challenge->id }}">
                        ...
                        @else
                            ...
                            <td class="px-4 py-2 text-right">
                                <button type="button" wire:click="edit({{ $challenge->id }})" class="rounded-md border border-gray-300 px-3 py-1.5 text-sm font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-200 dark:hover:bg-gray-700">Editar</button>
                                <button type="button" wire:click="delete({{ $challenge->id }})" wire:confirm="Excluir este desafio?" class="ml-2 rounded-md border border-red-300 px-3 py-1.5 text-sm font-medium text-red-600 hover:bg-red-50 dark:border-red-800 dark:text-red-400 dark:hover:bg-red-900/30">Excluir</button>
                            </td>
                        @endif
                    </tr>
                @endforeach
