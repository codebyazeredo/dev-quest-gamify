<x-modal title="Nova tarefa">
    <form wire:submit="save" class="space-y-4">
        ...
        @if ($developers->isNotEmpty())
            <div>
                <label for="task-assignee" class="block text-sm font-medium text-ink">Atribuir a</label>
                <select id="task-assignee" wire:model="assigned_to" class="mt-1 block w-full rounded-lg border border-line bg-card px-3 py-2.5 text-ink focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/30">
