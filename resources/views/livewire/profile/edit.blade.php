<x-modal title="Editar meus dados" max-width="max-w-2xl">
    <form wire:submit="save" class="space-y-4">
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            ...
            <div>
                <label class="block text-sm font-medium text-ink">E-mail de contato</label>
        ...
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div>
                <label class="block text-sm font-medium text-ink">E-mail de login</label>
                <input type="email" wire:model="login_email"
                    class="mt-1 block w-full rounded-lg border border-line bg-card px-3 py-2.5 text-ink focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/30">
                @error('login_email') <p class="mt-1 text-sm text-terracotta">{{ $message }}</p> @enderror
            </div>

            <div></div>

            <div>
                <label class="block text-sm font-medium text-ink">Nova senha</label>
                <input type="password" wire:model="password" placeholder="Deixe em branco para manter"
                    class="mt-1 block w-full rounded-lg border border-line bg-card px-3 py-2.5 text-ink focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary/30">
                @error('password') <p class="mt-1 text-sm text-terracotta">{{ $message }}</p> @enderror
            </div>

            <div>
                <label class="block text-sm font-medium text-ink">Confirmar nova senha</label>
